class CfgSFX 
{
    class POD_Sounds_Test_SFX 
	{
        ...
        POD_Sounds_Test[] = {"POD_Sounds\POD_Sounds\sounds\POD_Sounds_test.ogg",100,1,200,1,0,0,0};
        empty[] = {"",0,0,0,0,0,0,0};
    };
    ...
    class POD_Sounds_AirRaid_SFX
	{
        ...
        sounds[] = {"POD_Sounds_AirRaid"};
        POD_Sounds_AirRaid[] = {"POD_Sounds\POD_Sounds\sounds\POD_Sounds_AirRaid.ogg",300,1,2000,1,0,0,0};
        empty[] = {"",0,0,0,0,0,0,0};
    };
	
    class POD_Sounds_Incoming_SFX
	{
        name = "[POD] Incoming incoming";
